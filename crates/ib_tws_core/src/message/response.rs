...
impl Response {
    pub fn request_id(&self) -> Option<i32> {
        match self {
            Response::HandshakeAck(ref _msg) => Some(OPCODE_HANDSHAKE),
            ...
            Response::MarketRule(ref _msg) => Some(OPCODE_REQ_MARKET_RULE),
            ...
            Response::NewsProviderMsg(ref _msg) => Some(OPCODE_REQ_NEWS_PROVIDERS),
            Response::TickNewsMsg(ref msg) => Some(msg.req_id),
            Response::HeadTimestampMsg(ref msg) => Some(msg.req_id),
            Response::MktDepthExchangesMsg(ref _msg) => Some(OPCODE_REQ_MKT_DEPTH_EXCHANGES),
            Response::SymbolSamplesMsg(ref msg) => Some(msg.req_id),
            Response::FamilyCodesMsg(ref _msg) => Some(OPCODE_REQ_FAMILY_CODES),
            ...
            Response::VerifyAndAuthCompletedMsg(ref _msg) => Some(OPCODE_VERIFY_AND_AUTH_REQUEST),
            Response::VerifyAndAuthMessageMsg(ref _msg) => Some(OPCODE_VERIFY_AND_AUTH_MESSAGE),
            Response::DisplayGroupUpdatedMsg(ref msg) => Some(msg.req_id),
            Response::DisplayGroupListMsg(ref msg) => Some(msg.req_id),
            Response::VerifyCompletedMsg(ref _msg) => Some(OPCODE_VERIFY_REQUEST),
            Response::VerifyMessageApiMsg(ref _msg) => Some(OPCODE_VERIFY_MESSAGE),
            Response::CommissionReportMsg(ref _msg) => None,
            ...
            Response::AcctDownloadEndMsg(ref _msg) => None,
            Response::OpenOrderEndMsg(ref _msg) => None,
            ...
            Response::CurrentTimeMsg(ref _msg) => Some(OPCODE_REQ_CURRENT_TIME),
            Response::ScannerDataMsg(ref msg) => Some(msg.req_id),
            Response::ScannerParametersMsg(ref _msg) => Some(OPCODE_REQ_SCANNER_PARAMETERS),
            Response::HistoricalDataMsg(ref msg) => Some(msg.req_id),
            Response::ReceiveFaMsg(ref _msg) => Some(OPCODE_REQUEST_FA),
            Response::ManagedAcctsMsg(ref _msg) => Some(OPCODE_REQ_ACCOUNT_UPDATES),
            ...
            Response::NextValidIdMsg(ref _msg) => Some(OPCODE_REQ_IDS),
            Response::OpenOrderMsg(ref _msg) => Some(OPCODE_REQ_OPEN_ORDERS),
            Response::ErrMsgMsg(ref msg) => Some(msg.id),
            Response::AcctUpdateTimeMsg(ref _msg) => None,
            Response::PortfolioValueMsg(ref _msg) => None,
            Response::AcctValueMsg(ref _msg) => None,
            Response::OrderStatusMsg(ref _msg) => None,
            ...
            Response::PositionEndMsg(ref _msg) => None,
            Response::PositionMsg(ref _msg) => None,
            ...
            Response::TickByTickNoneMsg(ref _msg) => None,
